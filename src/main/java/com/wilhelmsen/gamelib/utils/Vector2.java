...
public class Vector2 {
    ...
    /**
     * Returns the squared magnitude of the vector. Use this to spare resources if comparing the
    ...
    /**
     * Sets vector to random values. If xlow or yhigh i higher than counterpart, vector will remain as
     * before.
     *
     ...
     * @param fraction The step in which to do it by. (0-1). Higher numbers result in faster
     *                 interpolation
     * @return This vector for chaining
     */
    ...
    /**
     * Does not work. FIXME Applies circular interpolation to the vector. Less accurate but more
     * effective than lerp.
     *
    ...
    /**
     * Returns a normal vector for this vector This is flipped compared to getNormal()
     *
     * @return Not normalized normal vector
     */
    ...
    /**
     * Use to hinder unwanted changes when passing as parameter and using in calculations and the
     * likes.
     *
